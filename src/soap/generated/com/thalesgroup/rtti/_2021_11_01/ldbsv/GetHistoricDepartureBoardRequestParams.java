...
public class GetHistoricDepartureBoardRequestParams {
    ...
    @XmlElementRef(name = "historicDateTime", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> historicDateTime;
    @XmlElementRef(name = "depBoardDate", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<DepBoardDateType> depBoardDate;
    @XmlElementRef(name = "depBoardTime", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> depBoardTime;
    @XmlSchemaType(name = "unsignedShort")
    protected int timeWindow;
    @XmlElementRef(name = "filterCRS", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filterCRS;
    @XmlElementRef(name = "filterCRSType", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<FilterType> filterCRSType;
    @XmlElementRef(name = "filterTOC", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
