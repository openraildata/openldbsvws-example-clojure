...
public class QueryHistoricServicesRequestParams {
    ...
    @XmlElementRef(name = "scheduleStartDate", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<DepBoardDateType> scheduleStartDate;
    @XmlElementRef(name = "timeFilter", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> timeFilter;
    @XmlElementRef(name = "routeCRSFilter", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> routeCRSFilter;
    @XmlElementRef(name = "tocFilter", namespace = "http://thalesgroup.com/RTTI/2021-11-01/ldbsv/", type = JAXBElement.class, required = false)
